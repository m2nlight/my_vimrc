...
-- vim.opt.guifont = "JetBrainsMonoNL Nerd Font Mono,LXGW WenKai Mono:h11"
-- vim.opt.guifont = "CaskaydiaCove Nerd Font,LXGW WenKai Mono:h11"
-- vim.opt.guifont = "Hack Nerd Font,LXGW WenKai Mono:h11"
