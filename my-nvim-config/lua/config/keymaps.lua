...
m.set({ "n", "v" }, "<C-`>", function() Snacks.terminal.focus(nil, { cwd = LazyVim.root() }) end, { desc = "Terminal (Root Dir)" })
...
m.set("n", "A-=", function() LazyVim.format({ force = true }) end, { desc = "Format" })
m.set("v", "A-=", function() vim.lsp.buf.format({ async = true }) end, { desc = "Format Selection" })
